# Export Packing List- Frontend Code

This directory contains the frontend code for the Export Packing List plugin.
...
This will compile the frontend into the `../export_packing_list/static` directory (ready for distribution).
