 ...
 */
function ExportPackingListDashboardItem({
  context
}: {
  ...
  const pluginName: string = 'ExportPackingList';
...
//  component
export function renderExportPackingListDashboardItem(
  context: InvenTreePluginContext
) {
  checkPluginVersion(context);
  return <ExportPackingListDashboardItem context={context} />;
}
