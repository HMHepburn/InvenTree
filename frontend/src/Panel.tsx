 ...
 */
function ExportPackingListPanel({
  context
}: {
  ...
  return (
    <>
      ...
      <Stack gap='xs'>
        ...
        <Text>This is a custom panel for the ExportPackingList plugin.</Text>
        <SimpleGrid cols={2}>
...
export function renderExportPackingListPanel(context: InvenTreePluginContext) {
  checkPluginVersion(context);

  return <ExportPackingListPanel context={context} />;
}
